      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-[440px] relative">
        ...
        <div className="p-8">
          ...
          <div className="space-y-3">
            <button className="flex items-center cursor-pointer justify-center w-full border-2 border-gray-200 bg-white text-gray-700 rounded-lg py-3.5 px-4 hover:border-gray-300 transition-colors font-medium"
